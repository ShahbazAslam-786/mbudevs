...
export const Testimonial = () => {
  ...
  return (
    <div className=" w-full pt-12">
      <div className="w-full h-full pt-[3rem] pl-[1rem] pr-[1rem]">
        <div className="container">
          <div className="testimonial-decription">

            <div className="w-full ">
              <p className="text-black pb-[1.5rem] text-base leading-[30px] font-primary">
