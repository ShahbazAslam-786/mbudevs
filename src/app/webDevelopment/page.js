      ...
      <div className="mx-auto">
        <div className="relative w-full bg-gray-100 px-10 pt-16">
          <div className="text-center py-16 px-4">
            ...
            <p className="text-base max-w-4xl text-gray-900 mx-auto font-primary ">
              MBUDevs is a highly reputable web development company based in Pakistan, driven by a team of skilled and passionate
              web designers who excel in their craft. We understand the challenges of site development and are dedicated to
              delivering top-notch solutions. Our commitment doesn&apos;t end until the job is done. At MBUDevs, we bring your vision to life,
        ...
        <div className="bg-white p-4 mt-12">
          ...
          <p className="text-base mb-6 text-gray-900 px-4 sm:px-16 lg:px-[170px] leading-relaxed  font-primary">
            MBUDevs Technologies stands as a premier web design and development company in Pakistan, offering customized end-to-end solutions. Our services combine creativity, functionality, and adaptability to perfectly align with your unique requirements and preferences.
            <br />
            <br />
